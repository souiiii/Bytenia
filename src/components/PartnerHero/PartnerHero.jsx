      ...
      <div className="container" style={{ maxWidth: '1000px' }}>
        <div className="partner-hero-card">
          ...
          <p className="subtitle text-gray" style={{ maxWidth: '700px', margin: '0 auto', fontSize: '1rem', lineHeight: '1.6' }}>
            Join the Byteania Partner Program to deliver powerful infrastructure solutions while adding continuous revenue streams. Expand your product offerings with our stable, scalable cloud services.
          </p>
        </div>
      </div>
    </section>
