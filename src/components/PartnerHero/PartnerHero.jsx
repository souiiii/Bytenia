      ...
      <div className="container">
        <div className="partner-hero-card">
          ...
          <p className="subtitle text-gray" style={{ maxWidth: '850px', margin: '0 auto', fontSize: '1rem', lineHeight: '1.6', fontWeight: 300 }}>
            Tempest's Partner Program is designed for infrastructure providers, resellers, and strategic operators looking to leverage predictable margins, enterprise-grade hardware, and global deployment capabilities.
          </p>
        </div>
      </div>
    </section>
