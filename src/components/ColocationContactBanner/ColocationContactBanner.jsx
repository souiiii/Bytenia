...
const ColocationContactBanner = () => {
  return (
    <section className="colocation-contact-banner section">
        ...
        <div className="choice-card">
          ...
          <div className="choice-content">
            <h3 className="choice-title text-white">
              <span style={{fontWeight: 300}}>NOT SURE </span> WHICH OPTION <span style={{fontWeight: 300}}>TO CHOOSE?</span>
            </h3>
...
export default ColocationContactBanner;
