...
import "./DedicatedServerPlans.css";
...
export const serversData = [
  ...
  },
  {
    ...
    cpuDetails: "28C / 56T @ 2.0GHz / 3.1GHz",
    benchmark: "Scored 39,200 on a CPU benchmark",
    countryCode: "de",
    city: "Frankfurt",
    country: "Germany",
    ram: "128GB, Type DDR5",
  ...
  {
    id: 5,
    cpuModel: "AMD EPYC 7502P",
    cpuDetails: "32C / 64T @ 2.5GHz / 3.3GHz",
    benchmark: "Scored 42,500 on a CPU benchmark",
    countryCode: "au",
    city: "Sydney",
    country: "Australia",
    ram: "256GB ECC RAM",
  ...
  },
  {
    ...
    cpuDetails: "16C / 32T @ 3.4GHz / 4.9GHz",
...
const DedicatedServerPlans = () => {
  ...
  return (
    <section className="ds-servers section">
      <div className="container" style={{ maxWidth: "1200px" }}>
        <div className="text-center" style={{ marginBottom: "40px" }}>
          <h2 className="ds-servers-header">
            <strong>Dedicated Server</strong> <span>Plans</span>
          </h2>
          <p className="ds-servers-sub">
            High-performance infrastructure configurations<br/>engineered for <strong>enterprise hosting workloads.</strong>
          </p>
        </div>

        <div className="ds-location-filters">
          {filterLocations.map((loc) => (
            <button
              key={loc.id}
              className={`ds-loc-pill ${activeLoc === loc.id ? "active" : ""}`}
        ...
        <div className="ds-selectors-row">
          <div className="ds-selectors-group">
            <div className="ds-select-box">
              <label>CPU</label>
          ...
          <div className="ds-sort-box" onClick={() => setSortOrder((prev) => (prev === "asc" ? "desc" : "asc"))}>
            <span>Sort by:</span>
        ...
        <div className="ds-server-cards">
          {filteredServers.length === 0 ? (
            ...
            (isExpanded ? filteredServers : filteredServers.slice(0, 5)).map((server) => (
              <div key={server.id} className="ds-server-card">
                <div className="ds-card-left">
                  <div className="ds-card-top">
                    <h3 className="ds-cpu-title">
                      {server.cpuModel} <span>| {server.cpuDetails}</span>
                    </h3>
                    <div className="ds-benchmark">{server.benchmark}</div>
                  </div>

                  <div className="ds-card-metrics">
                    <div className="ds-metric-item">
                      <img src={`https://flagcdn.com/w40/${server.countryCode}.png`} className="ds-metric-flag" alt="loc" />
                      <div className="ds-metric-text">
                    ...
                    <div className="ds-metric-item">
                      <MemoryStick size={24} className="ds-metric-icon" />
                      <div className="ds-metric-text">
                    ...
                    <div className="ds-metric-item">
                      <HardDrive size={24} className="ds-metric-icon" />
                      <div className="ds-metric-text">
                    ...
                    <div className="ds-metric-item">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ds-metric-icon">
                ...
                <div className="ds-card-right">
                  <div className="ds-price-pill">
                    <div className="ds-price-val">
                      {server.price} <span>/ month</span>
                    </div>
                    <button className="btn-light ds-configure-btn">
                      Configure Server
                    </button>
                  </div>
                </div>
        ...
        {filteredServers.length > 5 && (
          <div className="text-center" style={{ marginTop: "40px" }}>
            <button className="btn-outline ds-show-more" onClick={() => setIsExpanded(!isExpanded)}>
...
export default DedicatedServerPlans;
