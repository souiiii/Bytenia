...
const serversData = Array(5).fill({
  id: Math.random(),
      ...
      <div className="container" style={{maxWidth: '1200px'}}>
        ...
        <div className="text-center" style={{marginBottom: '40px'}}>
          ...
          <p className="ent-servers-sub">
            Choose from a range of enterprise-grade dedicated servers optimized for performance, reliability,<br/>
            and scalability. Each configuration is designed to support demanding workloads and <strong>can be<br/>
            customized to match your business needs.</strong>
          </p>
        </div>
            ...
            <div key={server.id} className="ent-server-card">
              <div className="ent-card-left">
                ...
                <div className="ent-card-metrics">
                  ...
                  <div className="ent-metric-item">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ent-metric-icon"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><line x1="8" x2="16" y1="12" y2="12"/><line x1="12" x2="12" y1="8" y2="16"/></svg>
                    <div className="ent-metric-text">
              ...
              <div className="ent-card-right">
                <div className="ent-price-pill">
                  <div className="ent-price-val">{server.price} <span>/ month</span></div>
                  <button className="btn-light ent-configure-btn">Configure Server</button>
                </div>
              </div>
