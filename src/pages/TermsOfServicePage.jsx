        ...
        <div className="tos-content-container">
          <div className="tos-intro">
            <p className="tos-intro-p">
              These Terms of Service ("Terms") govern your access to and use of Bytenia's standard services, including our web platform, APIs, colocation, and networking solutions.
            </p>
            <p className="tos-intro-p">
              By clicking "I Agree," by creating a Bytenia account, or by using our Services, you agree to these Terms. If you are accepting these Terms on behalf of a company or other legal entity, you represent that you have the authority to bind that entity to these Terms.
            </p>
            <p className="tos-intro-p">
          ...
          <section className="tos-section">
            ...
            <p>Bytenia delivers compute, networking, and colocation services as described on our pricing pages and system documentation. Service availability relies on upstream internet routing and hardware functionality.</p>
          ...
          <section className="tos-section">
            ...
            <p>The delivery time for specific services varies depending on requested hardware configurations, stock availability, and data center locations. Bytenia generally provisions standard configurations within one hour of payment clearance.</p>
          </section>
          ...
          <section className="tos-section">
            ...
            <p>We bill in advance for most services. Bytenia utilizes third-party payment infrastructure via Stripe and PayPal. We do not natively process, handle, or retain complete credit card numbers on our infrastructure.</p>
          ...
          <section className="tos-section">
            ...
            <p>Bytenia is expressly not responsible for breaches, data loss, or system compromise resulting from your software architecture.</p>
          </section>
          ...
          <section className="tos-section">
            ...
            <p>You retain all rights to any underlying data, applications, and architecture you deploy via Bytenia hardware. Bytenia retains all rights, title, and interest in and to our Services, including the platforms, network configurations, global infrastructure, logos, and underlying proprietary software.</p>
          </section>

          <section className="tos-section">
            <h3>13. CUSTOMER CONTENT AND DATA</h3>
            <p>Bytenia does not inspect, modify, or assume ownership over any data structures you route or mount via our architecture. You are entirely responsible for backing up your data to external redundant locations.</p>
          </section>
          ...
          <section className="tos-section">
            ...
            <p>Upon termination, your account data will be permanently wiped from our storage architectures. Bytenia fundamentally assumes no liability for the resultant destruction of active application environments.</p>
          </section>
          ...
          <section className="tos-section">
            ...
            <p>To the maximum extent permitted by applicable law, in no event will Bytenia be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues.</p>
          ...
          <section className="tos-section">
            <h3>20. CONTACT</h3>
            <p>If you have any questions or concerns about these Terms, please contact us at legal@bytenia.com.</p>
          </section>
